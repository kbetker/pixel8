...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Pixel_Comments',
      [
        { pixelStoryId: 1, pixelUserId: 11, body: "I like that part where the thing happened.", createdAt: "2021-01-01", updatedAt: "2021-01-01" },
        ...
        { pixelStoryId: 1, pixelUserId: 12, body: "Is this the real life?", createdAt: "2021-01-01", updatedAt: "2021-01-01" },
        { pixelStoryId: 2, pixelUserId: 2, body: "Is this just fantasy?", createdAt: "2021-01-01", updatedAt: "2021-01-01" },
        { pixelStoryId: 3, pixelUserId: 13, body: "Caught in a landslide, no escape from reality.", createdAt: "2021-01-01", updatedAt: "2021-01-01" },
        ...
        { pixelStoryId: 2, pixelUserId: 14, body: "Because I'm easy come, easy go, little high, little low.", createdAt: "2021-01-01", updatedAt: "2021-01-01" },
        { pixelStoryId: 3, pixelUserId: 15, body: "Any way the wind blows, doesn't really matter to me.", createdAt: "2021-01-01", updatedAt: "2021-01-01" },
        ...
        { pixelStoryId: 3, pixelUserId: 67, body: "Dude, I F***ING LOVE THIS GAME", createdAt: "2021-01-01", updatedAt: "2021-01-01" },
